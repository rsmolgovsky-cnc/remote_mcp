...
try:
    # Configure root logger to suppress all console output
    logging.basicConfig(
        filename=log_file,
        level=logging.DEBUG,
    ...
    # Suppress all root logger handlers that output to console
    ...
    # Fallback: log errors to a separate file
    with open("/tmp/mcp_research_server_init_error.log", "w") as f:
        f.write(f"Failed to set up logging: {e}\n")

# Disable all FastMCP and other library loggers
...
def extract_info(paper_id: str) -> str:
    ...
    # Return early if papers directory doesn't exist yet
